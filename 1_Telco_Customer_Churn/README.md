...
* **The New Customer Flight Risk:** There is a strong negative correlation between tenure and churn. Customers are highly likely to leave within their first 10 months. If they survive the first year, their loyalty increases dramatically.
...
To move beyond historical analysis, this project incorporates advanced statistical testing and machine learning:
* **Statistical Validation:** Conducted a **Chi-Square Test of Independence** to mathematically prove the significant correlation between Internet Service types and customer churn.
* **Predictive Modeling:** Engineered and deployed a **Random Forest Classifier** to predict future churn. The model achieved an accuracy of **78.5%**, providing the business with an automated early-warning system to identify at-risk customers before they cancel their subscriptions.
...
* **Deploy Churn Prediction Model:** Utilize the Random Forest algorithm to flag "at-risk" customers in the database, allowing the retention team to proactively dispatch targeted offers before the customer initiates a cancellation.
